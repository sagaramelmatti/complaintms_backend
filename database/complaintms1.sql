...
--
-- Host: 127.0.0.1
-- Generation Time: May 30, 2023 at 09:15 AM
...
INSERT INTO `complaints` (`id`, `title`, `description`, `userId`, `departmentId`, `locationId`, `status`, `comment`, `complaint_added_date`, `complaint_resolved_date`, `ticketNumber`, `ticketNumberSequance`, `createdAt`, `updatedAt`) VALUES
(1, 'windows not working', 'Windows not working ', 6, 2, 2, 'Resolved', 'Resolved', '2023-05-30 06:56:23', '2023-05-30 06:57:33', 1, '00001', '2023-05-30 06:56:23', '2023-05-30 06:57:33');
...
(6, 'sagar melmatti', 'sagaramelmatti@gmail.com', '$2a$08$/Wj2b6S06dUWandw5.q4P.6fZoxFwk2C4TOCjH1P1lTH.0AdOt5fy', 'A', 2, 2, 'U', '2023-05-30 06:54:12', '2023-05-30 07:01:01');
...
('2023-05-30 06:54:12', '2023-05-30 06:54:12', 2, 6),
